  ...
  $count=0;
	...
	echo "<ul style='display: block;'>";
     while($valOf=mysql_fetch_array($find)){
      $count++;
       echo"<li onclick='homeUniSearchLeftNav(this.id)' id='mainUniliLeftNav".$count."'>"."<span class='nn'>".$valOf['school_name']."</span>"."<span class='main'>".$valOf['school_name']."(".$valOf['school_nick_name'].")"."</span>"."<span class='sub'>".$valOf['city_name'].",".$valOf['state_name']."</span>". "</li>";
     }
     exit;
     echo "</ul>";
   }
   ...
   if (isset($_REQUEST["profName"]) && isset($_REQUEST["uniNam"]) ) {
     ...
     echo "<ul style='display: block;'>";
       while($valOf=mysql_fetch_array($find)){
         $count++;
         echo"<li onclick='homeFronSearchLeftNav(this.id)' id='mainProfliLeftNav".$count."'>"."<span class='main'>".$valOf['first_name']."</span>"."<span class='sub'>".$valOf['first_name'].",</span><span class='sub'>".$valOf['last_name']."</span><span class='sub'> At ".$valOf['school_name']."</span>". "</li>";
       }
       exit;
     echo "</ul>";
   }
...
/*if search uni according to country for rate in main page*/
  ...
  echo "<ul style='display: block;'>";
     while($valOf=mysql_fetch_array($find)){
      $count++;
       echo"<li onclick='homeCntUniSearchLeftNav(this.id)' id='LeftNavCntUnili".$count."'>"."<span class='nn'>".$valOf['school_name']."</span>"."<span class='main'>".$valOf['school_name']."(".$valOf['school_nick_name'].")"."</span>"."<span class='sub'>".$valOf['city_name'].",".$valOf['state_name']."</span>". "</li>";
     }
     exit;
     echo "</ul>";
   }
